            ...
            this.registerEndpoints([{
                ...
                options: {
                    ...
                    graphiqlOptions: {
                        ...
                        subscriptionsEndpoint: `${process.env.WS_SSH ? 'wss' : 'ws'}://${process.env.WS_PATH || 'localhost'}:${config.APP_CONFIG.port || process.env.API_PORT || process.env.PORT}/subscriptions`,
