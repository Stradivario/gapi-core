...
export   
  type IOprEnum = 'EQL' | 'GT' | 'GTE' | 'IN' | 'LT' | 'LTE' | 'NE' | 'NIN';
...
export   
  type IOprExistsEnum = 'EXISTS' | 'NOT_EXISTS';
...
export   /**
  ...
  */
  type IGeoJSONTypeEnum = 'Point' | 'MultiPoint' | 'LineString' | 'MultiLineString' | 'Polygon' | 'MultiPolygon' | 'GeometryCollection' | 'Feature' | 'FeatureCollection';
...
export   /**
  ...
  */
  type GeoJSONCRSProperties = IGeoJSONNamedCRSProperties | IGeoJSONLinkedCRSProperties;
